...
export RAMFS_SOURCE=`readlink -f $KERNELDIR/../boeffla-ramdisk`
export PARENT_DIR=`readlink -f ..`
export USE_SEC_FIPS_MODE=true
CROSS_COMPILE=$PARENT_DIR/android_prebuilt/linux-x86/toolchain/toolchains/arm-eabi-4.4.3/bin/arm-eabi-
